...
return [
    ...
    */
    ...
    'default_classes' => [
        'row' => [
            'even' => 'tw__divide-x tw__divide-gray-100 tw__text-sm tw__text-gray-900 tw__bg-gray-100',
            'odd' => 'tw__divide-x tw__divide-gray-100 tw__text-sm tw__text-gray-900 tw__bg-gray-50',
            'selected' => 'tw__divide-x tw__divide-gray-100 tw__text-sm tw__text-gray-900 tw__bg-yellow-100',
        ],
        'cell' => 'tw__whitespace-no-wrap tw__text-sm tw__text-gray-900 tw__px-6 tw__py-2',
    ],
];
