<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
	<div class="app-brand sia">
		<a href="{{ route('adm.index') }}" class="app-brand-link">
			<span class="app-brand-logo sia">
				<svg
					width="25"
					viewBox="0 0 25 42"
					version="1.1"
			...
			<span class="app-brand-text sia menu-text fw-bolder ms-2">Sneat</span>
		</a>
    ...
    <ul class="menu-inner tw__pt-8 tw__pb-40 md:tw__pb-12">
		@if (config('siaji.adm.sidebar') && count(config('siaji.adm.sidebar')) > 0)
			@foreach (config('siaji.adm.sidebar') as $menu)
