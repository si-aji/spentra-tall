                    ...
                    <ul class="navbar-nav flex-row align-items-center">
                        ...
                        <li class="nav-item navbar-dropdown dropdown-user dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                <span class="fw-semibold d-block">{{ \Auth::guard('adm')->user()->name }}</span>
                                                <small class="text-muted">{{ \Auth::guard('adm')->user()->email ?? '-' }}</small>
                                            </div>
                                        </div>
                                    </a>
                                </li>
                                ...
                                {{-- <li>
                                    <a class="dropdown-item" href="{{ route('adm.profile.index') }}">
                                ...
                                <li>
                                    <a class="dropdown-item" href="{{ route('adm.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
