<div x-data="{
    ...
    <span x-cloak x-show="edit">
        <input class="tw__border-blue-400 tw__px-2 tw__py-1 tw__mx-2 tw__my-1 tw__rounded focus:tw__outline-none focus:tw__border" x-ref="input" value="{!! htmlspecialchars($value) !!}"
